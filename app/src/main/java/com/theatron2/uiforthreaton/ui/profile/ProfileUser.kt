...
data class ProfileUser(val name:String, val title:String, val url:String, val thumbnailphoto:String, val id:String, val desc:String,
                       val view:String, val likes:String, val dislikes:String, val shares:String, val photo:String, val vnum:String, val date:String, val time:String, val status:String=""):Serializable
{
